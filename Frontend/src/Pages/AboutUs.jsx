    ...
    <div className="bg-pink-50 text-gray-800 font-sans min-h-screen">
      ...
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="space-x-4">
            ...
            <a href="/about-us" className="text-pink-600 font-semibold">About</a>
            <a href="/contact-us" className="text-gray-600 hover:text-pink-600">Contact</a>
          </nav>
        </div>
      </header>
      ...
      <section className="bg-white py-20">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold mb-4 text-pink-700">A New Era of Wedding Invitations</h2>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <h3 className="text-2xl font-semibold mb-6 text-pink-800">What We Do</h3>
          <div className="grid md:grid-cols-3 gap-8 text-left">
            <div>
              <h4 className="font-bold mb-2 text-pink-700">Custom Wedding Invitations</h4>
            ...
            <div>
              <h4 className="font-bold mb-2 text-pink-700">Doorstep Delivery</h4>
            ...
            <div>
              <h4 className="font-bold mb-2 text-pink-700">Add-On Gifts</h4>
      ...
      <section className="py-16 bg-pink-50">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h3 className="text-2xl font-semibold mb-4 text-pink-800">Our Promise</h3>
          <p className="text-gray-700">
      ...
      <footer className="bg-white border-t mt-20">
        <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col md:flex-row justify-between items-center text-center md:text-left">
          <p className="text-gray-500 text-sm mb-2 md:mb-0">&copy; 2025 Sandesh. Made with ❤️ for every Indian wedding.</p>
